...
<p>En cualquiera de los dos casos, <strong>otorga mayor peso visual a la acción principal</strong>. Con el fin de reducir la probabilidad de que el usuario cometa errores.</p>
